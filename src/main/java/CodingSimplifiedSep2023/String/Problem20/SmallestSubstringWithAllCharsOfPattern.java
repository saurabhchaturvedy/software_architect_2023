...
public class SmallestSubstringWithAllCharsOfPattern {
    ...
    public static void main(String[] args) {
        ...
        String pattern = "aabc";
        SmallestSubstringWithAllCharsOfPattern smallestSubstringWithAllCharsOfPattern = new SmallestSubstringWithAllCharsOfPattern();
        System.out.println(smallestSubstringWithAllCharsOfPattern.smallestSubstringWithAllPatternCharcaters(str, pattern));
    }
}
